...
?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'det_venit_net',$model->getOptions(3),array('empty' => '(Selectează form determinării venitului')); ?>
...
<!--
	<div class="row">
		<?php echo CHtml::link('Adresa detaliu', '#', array('onclick'=>'$("#adresa_det").dialog("open"); return false;',));?>
	</div>
-->
	<div class="row">
